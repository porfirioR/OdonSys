...
export class OrthodonticApiService {
  ...
  public create = (request: OrthodonticRequest): Observable<OrthodonticApiModel> => {
    return this.http.post<OrthodonticApiModel>(this.baseUrl, request)
  }

  public update = (id: string, request: OrthodonticRequest): Observable<OrthodonticApiModel> => {
